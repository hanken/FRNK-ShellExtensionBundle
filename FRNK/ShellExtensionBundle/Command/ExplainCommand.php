...
class ExplainCommand extends ContainerAwareCommand {
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        $output->writeln($this->getContainer()->get("templating")->render("FRNKShellExtensionBundle::explain.output.cli.twig", $templateVars));
    }
...
The <info>explain</info> command explains a service:
  ...
  <info>php app/console extension:explain doctrine</info>
